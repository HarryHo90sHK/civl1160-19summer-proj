									...
									<Row className="category-card-row" type="flex" justify="space-around">
										<Col><Card
											...
											cover={
												<a
													onClick={() => {
														this.props.history.push("/categories/昔日報雜");
													}}
												>
													<img className="card-cover"
														 src="https://cdn.pixabay.com/photo/2015/01/04/15/07/magazines-588346_960_720.jpg"/>
												</a>
											}
										>
										...
										<Col><Card
											...
											cover={
												<a
													onClick={() => {
														this.props.history.push("/categories/台前幕後");
													}}
												>
													<img className="card-cover"
