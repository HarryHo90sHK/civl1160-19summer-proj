						...
						<Layout>
							...
							<Content className="content-container">
								<Card className="card-category"
								      title={"文章分類: " + renderChinese(this.props.match.params["category"])}>
														...
														case "clothing":
															return (
																<Card
																	...
																	cover={<img className="card-cover"
								...
								<Card className="card-category" title="最新文章">
									<List
										...
										size="large"
										dataSource={
											this.props.Meteor.collection.blogs.filter((blog) => {
